<template>
  ...
  <v-app-bar app>
    ...
    <div><v-menu bottom >
      ...
      <v-list>
          <v-list-item ><v-list-item-title><router-link :to = "{ name:'messages' }" class="dropdown-item">Messages</router-link></v-list-item-title></v-list-item>
          ...
          <v-list-item v-if="IsAuthenticated "><v-list-item-title><router-link :to = "{ name:'moderate' }" class="dropdown-item">Moderating</router-link></v-list-item-title></v-list-item>
          <v-list-item v-if="IsAuthenticated "><v-list-item-title><router-link :to = "{ name:'statistics' }" class="dropdown-item">Statistics</router-link></v-list-item-title></v-list-item>
...
export default {
  ...
  components: {
      MemeEditor
  }, computed: mapState('authentication',{IsAuthenticated:'accessToken'})
};
</script>
<style>
.title {
